...
import 'package:tonutils/tonutils.dart'
    show loadTransaction, storeTransaction, Cell, beginCell;

void main() {
  group('dataformat/type/transaction', () {
    test('Parsing transaction', () {
      ...
      final cell = Cell.fromBocBase64(boc);

      final tx = loadTransaction(cell.beginParse());
      final cell2 = beginCell().store(storeTransaction(tx)).endCell();

      expect(cell.equals(cell2), true);
    });

    test('Parsing tick-tock transactions', () {
    ...
    test('Parsing state init transaction', () {
      final boc =
    ...
    test('Parsing messages with external addresses', () {
