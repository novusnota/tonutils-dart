...
import 'package:tonutils/tonutils.dart'
    show BitBuilder, BitReader, InternalAddress, ExternalAddress;
...
void main() {
  group('dataformat/bitstring/bitreader', () {
    test('Reading uints from builder', () {
    ...
    test('Reading ints from builder', () {
    ...
    test('Reading var uints from builder', () {
    ...
    test('Reading var ints from builder', () {
    ...
    test('Reading coins from builder', () {
    ...
    test('Reading internal addresses from builder', () {
...
createTestExternalAddress(String seed) {
  final random = Random(seed.codeUnits.sum);
  final hash = Uint8List(32);
  ...
  var value = BigInt.parse(hex.encode(hash), radix: 16);

  return ExternalAddress(value, bitsForNumber(value, 'uint'));
}
