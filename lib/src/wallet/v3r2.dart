...
class WalletContractV3R2 implements Contract {
  @override
  ContractABI?
  ...
  /// Returns a new instance of a WalletContractV3R2
  static WalletContractV3R2 create({
    required Uint8List publicKey,
    int workChain = 0,
    int? walletId,
  }) {
    return WalletContractV3R2(publicKey, workChain, walletId);
  }
